...
for name,color in [('dark','#26333b'),('light','#e8e9e3')]:
...
(ROOT/'assets/img/logo-symbol.svg').write_text(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 68 68" color="#26333b">{symbol}</svg>')
(ROOT/'assets/img/logo-mark.svg').write_text(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80"><rect width="80" height="80" rx="18" fill="#26333b"/><g transform="translate(6 6)" color="#e8e9e3">{symbol}</g></svg>')
...
proof=f'<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="640"><rect width="1200" height="640" fill="#eeeee8"/><g transform="translate(100 95) scale(2.5)" color="#26333b">{letters}</g><path d="M80 320H1120" stroke="#d1d5d2"/><rect x="0" y="355" width="1200" height="285" fill="#26333b"/><g transform="translate(90 425) scale(1.4)" color="#e8e9e3">{letters}</g><g transform="translate(1020 430) scale(1.5)" color="#e8e9e3">{symbol}</g></svg>'
