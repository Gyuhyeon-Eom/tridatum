...
badge=f'<svg class="brand-badge" viewBox="0 0 80 80" aria-hidden="true"><rect width="80" height="80" rx="17" fill="#fff100"/><g transform="translate(6 6)" color="#000000">{symbol}</g></svg>'
...
(ROOT/'assets/img/logo-mark.svg').write_text(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80"><rect width="80" height="80" rx="18" fill="#fff100"/><g transform="translate(6 6)" color="#000000">{symbol}</g></svg>')
